...
def transform(description):
    mappings = {
        ...
        "coop|co-op|co op group": ("payment for shopping at CoOp", "Expenses:Other Expenses:Grocery shopping"),
        ...
        "off licen|otly road convenie|country stores|wisla super": ("payment for shopping at off licence shop", "Expenses:Other Expenses:Grocery shopping"),
        "home bargains": ("payment for shopping at Home Bargains", "Expenses:Other Expenses:Grocery shopping"),

        # bills
        "id mobile|sj3853zo5": ("phone payment", "Expenses:Bussiness Expenses:Phone"),
        "talktalk": ("Payment to Internet at TalkTalk", "Expenses:Other Expenses:HouseExpenses:Internet"),
        "fibrely": ("Payment to Internet at Fibrely", "Expenses:Other Expenses:HouseExpenses:Internet"),
        ...
        "cbmdc corporate": ("Payment for Bradford Council for garden waste", "Expenses:Other Expenses:HouseExpenses:CouncilTax"),
        ...
        "1111864145|1062345945": ("Tranfer to Polish current using Transferwise", "Current Money:Polish Accounts:NestBank Current Account"),
        ...
        "uber \*trip|uber\* trip|stagecoach": ("Payment for Uber trip", "Expenses:Other Expenses:Transport"),
        ...
        "burnley.*footbal|burnley f|fks stal mielec|bilety\.stalrzeszow": ("Payment for football tickets", "Expenses:Other Expenses:Travel and Entertainment"),
        "hotel|airbnb": ("Payment for hotel accomodation", "Expenses:Other Expenses:Travel and Entertainment:Accomodation"),
        "ticket office": ("Payment for entrance tickets", "Expenses:Other Expenses:Travel and Entertainment:Accomodation"),

        # withdraw cash
        "powerplay|eduletting|dioce|notemachine|soccerleagues|szymon krysiak|goals football|goals bradford|za trening|stefan skokan|maciej komorek|frame 2 complex": ("withdraw in cash machine", "Expenses:Other Expenses:Miscellaneous"),
        "205322 11jun|who internet|discovercars|sar mine|oxfam|obaeoudjs7|obakhqgtd8|bmb rem|tempcover|hpi check|cardtronics|covermy": ("withdraw in cash machine", "Expenses:Other Expenses:Miscellaneous"),
        "nat west bank|404144shipley|grange sports|bradford sports ce|hmcourts-svs": ("withdraw in cash machine", "Expenses:Other Expenses:Miscellaneous"),
        ...
        # car expenses
        "vehicle tax": ("Road tax payment", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Road Tax"),
        "petrol|fuel|sainsburys smkts|shell|bp st chads|sun garage|esso|bp mfg|bp greengates|whitwell|bp valli|bp bloody oaks|morr harwich|morr bradford.*on 11 dec": ("payment for petrol", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Fuel"),
        "gear up service|ziobrorecoverycar|northcliffe|servicing stop|jct car|f1auto|formula one autoce|halfords|f1 autocent|drive in service": ("Payment for car repair or service", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Services"),
        "ttc driver trainin|driver retraining": ("Payment for TTC speeding course", "Expenses:Other Expenses:Kia XCeed Expenses"),
        "axa insurance|1stcentralinsuranc|darwin insurance": ("Car insurance payment", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Insurance"),
        "2getherinsuran": ("Breakdown Cover", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Breakdown Cover"),
        "car parks|airedale nhs|city of york|ringgo|car park|ilkleytowncoun|wight coun|edward stre.*on 24|harrogate.gov|scarborough bc|cleveland|ncp limited": ("Car park payment", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Car Parks"),
        "parking|parki|leeds park row|citipark|riverbank|bath row": ("Car park payment", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Car Parks"),
        "harrogate borough|q park leeds": ("Car park payment", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Car Parks"),
        "motor depot.*on 03 may bcc": ("Buying car", "Expenses:Other Expenses:Kia XCeed Expenses:Kia XCeed - Buy Car"),
        "bowman cars ltd.*q50 bgc": ("Selling Infiniti Q50 car", "Expenses:Other Expenses:InfinitiQ50 expenses:InfinitiQ50 - Buy car"),
        ...
        "pret @mfg": ("Payment for coffee at Pret", "Expenses:Other Expenses:Dining"),
        "the malt": ("Payment for coffee at The Malt cafe", "Expenses:Other Expenses:Dining"),
        "crown and cushion": ("Payment for coffee at The Crown And Cushion", "Expenses:Other Expenses:Dining"),
        "buon cibo": ("Payment for coffee at Buon Cibo", "Expenses:Other Expenses:Dining"),
        ...
        "cultures": ("Payment for dining at The Cultures", "Expenses:Other Expenses:Dining"),
        ...
        "uber \*one": ("Payment for dining at Uber One", "Expenses:Other Expenses:Dining"),
        "q park the light": ("Payment for dining at Q Park The Light", "Expenses:Other Expenses:Dining"),
        "wakefield football": ("Payment for dining at Wakefield Football Center", "Expenses:Other Expenses:Dining"),
        "six poor folk": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "woodbank nurseries": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "station tavern": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "happy boba": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "lings catering": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "gordale refreshmen": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "buck inn": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "wapentake": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the engine room": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "bao machine": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "horse & trumpet": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "angel": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the greek corner": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the food hall": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "southwaite": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "mr whippy": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "aagrah": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "sociable folk": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "salt - calls landi": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the fox shipley": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "pride of shipley": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "wrose village cars": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the dutch fish": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the boathouse": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "salt bar and kitch": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "arcadia": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "tretower court": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "bwyty bach": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the bluebell inn": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the white monk lau": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "the anchor inn": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "cross keys inn": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "whitefriars servic": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "sumup \*friends of": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "sq \*\&then": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "bruschetta by": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "hesketh farm": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "taverners": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "pearls tearoom": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "crown and anchor": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "flip out bradford": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "vms roadchef": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "maas upt": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "enjoy travel": ("Payment for dining at Six Poor Folk", "Expenses:Other Expenses:Dining"),
        "buonissimo": ("Payment for dining at Buonissimo", "Expenses:Other Expenses:Dining"),
        "the sun inn": ("Payment for dining at The Sun Inn", "Expenses:Other Expenses:Dining"),
        "bivouac": ("Payment for dining at Bivouac Swinton", "Expenses:Other Expenses:Dining"),
        "whippy bradf": ("Payment for dining at The Mr Whippy Bradford", "Expenses:Other Expenses:Dining"),
        "silverland": ("Payment for dining at The Silverland of Hawo", "Expenses:Other Expenses:Dining"),
        "whitelocks": ("Payment for dining at Whitelocks", "Expenses:Other Expenses:Dining"),
        "northern guitars": ("Payment for dining at Northern Guitars", "Expenses:Other Expenses:Dining"),
        "ring obells": ("Payment for dining at Ring O'Bells", "Expenses:Other Expenses:Dining"),
        "jumperooz": ("Payment for dining at jumperooz", "Expenses:Other Expenses:Dining"),
        "wagon works": ("Payment for dining wagon works", "Expenses:Other Expenses:Dining"),
        "red eagle": ("Payment for dining at Red Eagle", "Expenses:Other Expenses:Dining"),
        "osborne house": ("Payment for dining at Osborne House", "Expenses:Other Expenses:Dining"),
        "mfg northam": ("Payment for dining at MFG Northam", "Expenses:Other Expenses:Dining"),
        "red osprey": ("Payment for dining at Red Osprey", "Expenses:Other Expenses:Dining"),
        "re isle": ("Payment for dining at Re isle", "Expenses:Other Expenses:Dining"),
        "wight fudg": ("Payment for dining at Isle of Wight Fudg", "Expenses:Other Expenses:Dining"),
        "the plaice to be": ("Payment for dining at The Plaice to be i", "Expenses:Other Expenses:Dining"),
        "catering kiosks": ("Payment for dining at Catering Kiosks", "Expenses:Other Expenses:Dining"),
        "smugglers inn": ("Payment for dining at The Smugglers Inn", "Expenses:Other Expenses:Dining"),
        "donnington park": ("Payment for dining at The Donnington Park", "Expenses:Other Expenses:Dining"),
        "wine barrel": ("Payment for dining at The Wine Barrel", "Expenses:Other Expenses:Dining"),
        "daytripper bar": ("Payment for dining at The DayTripper bar", "Expenses:Other Expenses:Dining"),
        "london spice grill": ("Payment for dining at The London Spice Grill", "Expenses:Other Expenses:Dining"),
        "michelle swift": ("Payment for dining at michelle swift", "Expenses:Other Expenses:Dining"),
        "klubhouse saltaire": ("Payment for dining at Klubhouse Saltaire", "Expenses:Other Expenses:Dining"),
        "ice cre": ("Payment for dining - ice cream", "Expenses:Other Expenses:Dining"),
        "rideonkiddi": ("Payment for dining - rideonkiddi", "Expenses:Other Expenses:Dining"),
        "dobricic": ("Payment for dining - Dobricic Foods", "Expenses:Other Expenses:Dining"),
        "subway 35709": ("Payment for dining - Subway", "Expenses:Other Expenses:Dining"),
        "marston": ("Payment for dining - Marston's Pubs", "Expenses:Other Expenses:Dining"),
        "southbank place le": ("Payment for dining - Southbank place", "Expenses:Other Expenses:Dining"),
        "broadwalk": ("Payment for dining - broadwalk", "Expenses:Other Expenses:Dining"),
        "caterin": ("Payment for dining / catering", "Expenses:Other Expenses:Dining"),
        "duke of york": ("Payment for dining at Duke Of York", "Expenses:Other Expenses:Dining"),
        ...
        "www.hl.co.uk|hlam ltd fund": ("into heargraves langsdown account", "Current Money:English Accounts:HL:HL Fund & Share Account"),
        ...
        "audible": ("Audible payment", "Expenses:Other Expenses:TVandInternet"),
        "tvlicensing": ("TV Licensing Payment", "Expenses:Other Expenses:TVandInternet"),
        ...
        "showcase leeds": ("Payment for delivery at Showcase Leeds cinema", "Expenses:Other Expenses:Entertainment"),
        ...
        "prezent dla mamy": ("Prezent dla mamy", "Expenses:Other Expenses:GiftsAndCharity"),

        # apps
        "google pla": ("Payment for app/movie at Google Play", "Expenses:Other Expenses:Travel and Entertainment"),

        # kids expenses
        "smyths": ("Toys at Smyths", "Expenses:Other Expenses:KidsExpenses"),
        "lego store": ("Toys at Lego store", "Expenses:Other Expenses:KidsExpenses"),
        ...
        "little daisy": ("Little Daisy's pay for soft play", "Expenses:Other Expenses:KidsExpenses"),
        "childcare": ("Childcare expense", "Expenses:Other Expenses:KidsExpenses"),
        ...
        "olesz": ("Zwrot kosztów od Jakub Olesz", "Income:Gifts Received"),
        ...
        "south kesteven": ("unknown payment", "Expenses:Other Expenses:Miscellaneous"),
        "barbers": ("unknown payment", "Expenses:Other Expenses:Miscellaneous"),
        "becketts bank": ("payment at becketts bank", "Expenses:Other Expenses:Miscellaneous"),
        "phone for you": ("payment at phone for you", "Expenses:Other Expenses:Miscellaneous"),
        "ringo ecom": ("payment at ringo ecom", "Expenses:Other Expenses:Miscellaneous"),
        "djf solicitors": ("Payment for Solicitors Fees", "Expenses:Other Expenses:Miscellaneous"),
        ...
        "commission for|loyalty reward": ("Bank account fees", "Expenses:Bussiness Expenses:Fees"),
        ...
        "hmrc (gov\.uk\ )?cotax|6232826602595": ("Corportation Tax Payment for XMementoIT for 2019/2020", "Expenses:Other Expenses:Taxes:Corporation Tax"),
        ...
        "packt birmingham|udemy|medium annual": ("professional courses and ebooks subscription", "Expenses:Bussiness Expenses:Trainings and courses"),
        ...
        "woodfield farm|travelodge|abbey cottage|booking.com": ("accomodation during business trip", "Expenses:Bussiness Expenses:Bussiness travels"),
        "the red mug|stgcoach/ctylink|az\ rdc\ catering|eb\ \*az\ cambridge|burger king brampt|wendy's brampton|trainline|the piccadilly|the pen and pencil|stamford post|cambridge leisure.*on 14 jun|earl of derby|the crown inn.*09 may|ok diner.*on 04 mar": ("expenses during business trip", "Expenses:Bussiness Expenses:Bussiness travels"),
        ...
        "burger king": ("payment for dining at Burger King", "Expenses:Other Expenses:Dining"),

        "premier inn": ("Payment for accomodation at Premier Inn", "Expenses:Other Expenses:Travel and Entertainment:Accomodation"),
        # ============= NEST BANK ACCOUNT ======================
        ...
        "wyborcza\.pl|czytaj\.rp\.pl|patronite": ("subskrypcja portalu internetowego", "Expenses:Other Expenses:Fees PL"),
        ...
        "stacja paliw|bp-jaslo|bp-babica|orlen|circle k|krakow bp-zakopianka|grosar": ("Platnosc za paliwo", "Expenses:Other Expenses:DaciaSandero expenses:DaciaSandero - Fuel"),
        ...
        "zamówienie 260396": ("Wyposażenie łazienki en-suite w Leroy Merlin + robocizna", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        ...
        "okresowy kotła": ("Płatność za przegląd pieca Viking Serwis", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        ...
        "faktura nr fv - 004/08/24": ("wykonczenia domu", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "faktura vat nr fa/587/2024": ("uruchomienie cwu i dojazd", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "ceg.y dekoracyjnej": ("Układanie cegiełki dekoracyjnnej", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "faktura 7/2024 - wykonanie prac": ("akcesoria do wykończenia łazienki i paneli", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "za panele": ("dokup paneli", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "bricomarche cyradis": ("akcesoria do wykończenia domu", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "zwrot za lampy": ("zwrot dla mamy za lampy", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "na dojazdy i drobne koszty": ("na dojazdy i drobne koszty", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "na klimatyzację": ("część kosztów za klimatyzację", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        ...
        "74340460729|81103804828|32166339/3312": ("Płatność za ubezpieczenie domu", "Current Money:Assets:HouseKleczanyPL:Oplaty:Rachunki"),
        ...
        "deichmann": ("Obuwie", "Expenses:Other Expenses:Clothes"),
        "karola brzezinska|jaslo spp|fahri cekic|otopark|ph sobniow|kaufland|marmax|biedronka|levitan|limoni|pepco|szubryt|delikatesy|(strzyzow|wisniowa|sedziszow mal|jaslo|rzeszow|iwonicz-zdroj|boguchwala|korczyna) zabka|zappka|stokrotka|lody u myszki|sklep wielobranzowy|lody stachura|jaslo lidl|cukiernia|zabka z9406|zabka zb270|al capone": ("Zakupy zywnosciowe w polsce", "Expenses:Other Expenses:Miscellaneous PLN"),
        ...
        "pizzeria (al capone|faraon)|kebab|keks|folkowe bistro|nowy kraftowy|t e a time|house of english|lodziarnia|bowling cegielnia|filika floro|fh monsun|dubiecko zamek|apcoa|mpl services|wezze krafta|kufle i widelce|piecyk zapiekanki|prestige 01|eko pralnia chemiczna|niebieskie migdaly|amorino jaslo|lody aga|lody |gastro rzeszow|baltona": ("Obiad wyjściowy w Polsce", "Expenses:Other Expenses:Dining PLN"),
        ...
        "1000200000000501481880|467619|467216|464418|jysk|rzeszow wito 200|leroy-merlin rzeszow 200|psb mrowka|strzyzow mrowka|leroy-merlin 1809|utwardzenie drogi|za kamień na drogę|c46fc096|mal mazak|460129|rzeszow leroy-merlin|sedziszow mal firma handlowo|merkury market": ("Platność za drobne rzeczy do wykończenia domu", "Current Money:Assets:HouseKleczanyPL:Wykonczenia"),
        "wypłata gotówki|rynek 3 strzyzow|rcd40594": ("withdraw in cash machine", "Expenses:Other Expenses:Miscellaneous PLN"),
        "od męża": ("od męża", "Current Money:Polish Accounts:NestBank Current Account"),
        "587694869|531378322|pisp1183076064|pisp1115051722|pisp1239694433": ("Przelew przez WISE na dom w PL z konta w UK", "Imbalance-PLN"),
        "przelew na telefon blik": ("przelew na telefon blik", "Expenses:Other Expenses:Miscellaneous PLN"),
        "funfactory sp|paradiso|luka gift|csvpn\.com|balice manual|park\ handlowy|jaworski e|virgin 77605|kasownik ztp krakow|mpk krakow|carfree|alkoholnaprezent|przelew wychodzący|eprezenty": ("jakas drobna płatność kartą", "Expenses:Other Expenses:Miscellaneous PLN"),
        ...
        "zwrot części": ("zwrot części pożyczki dla Zibera i Justyny", "Expenses:Other Expenses:Miscellaneous PLN"),
        "pożyczka prywatna dla": ("pożyczka dla Zibera i Justyny na auto", "Expenses:Other Expenses:Miscellaneous PLN"),
        "apteka|pod gwiazda": ("apteka", "Expenses:Other Expenses:Miscellaneous PLN"),

        "6780591194|zwrot leroy-merlin rzeszow|roksana strzyzow": ("inna transakcja", "Expenses:Other Expenses:Miscellaneous PLN"),
        "1043511462770": ("Transfer from Memento 1987 PayPal", "Current Money:English Accounts:Paypal accounts:Paypal Memento1987 PLN"),
        ...
        "linux\.pl": ("hosting of xmemento.it fee", "Expenses:Other Expenses:Fees PL"),
        ...
        "70 1870 1045 2078 1027 1517 0001|na ziemię|na nawożenie ziemi|na ogrodzenie|savings|na zwykle konto|oszczędności": ("from nestbank current", "Current Money:Polish Accounts:NestBank Current Account"),
        "na zwykły rachunek|na łazienkę leroy|zwrot czesci|piotra i justyny|na klimatyzacje": ("from nestbank savings", "Current Money:Polish Accounts:NestBank Current Account"),
