"""
Django settings for djangoCeleryRabbitMQRedis project.
...
ROOT_URLCONF = 'djangoCeleryRabbitMQRedis.urls'

WSGI_APPLICATION = 'djangoCeleryRabbitMQRedis.wsgi.application'
